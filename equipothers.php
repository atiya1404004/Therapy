...
<nav class="w3-bar w3-black">
 <h3> <a href="others.php" class="w3-button w3-bar-item">Home</a></h3>
 <h3> <a href="aboutothers.php" class="w3-button w3-bar-item">Doctor</a></h3>
 <h3> <a href="equipothers.php" class="w3-button w3-bar-item">Equipments</a></h3>
  <h3> <a href="index.php" class="w3-button w3-bar-item">Quit</a></h3>
</nav>
</div>
